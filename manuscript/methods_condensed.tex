...
Signed incidence operators are assembled from the finite-volume mesh. The
required OpenFOAM lists are \texttt{owner}, \texttt{neighbour} and the boundary
faces. These operators evaluate regional mass and energy differences:
\begin{equation}
