...
reported for that quantity. The common fine mesh is therefore retained as the
reference resolution for the model comparison, but the integral GCI does not
establish pointwise mesh independence of the three-dimensional temperature
field. Pressure loss and wall heat remain explicitly mesh-sensitive
observables.}{}
...
data-only PINN, physics-informed PINN, graph-operator and Physics-Attention
models use identical temperature, pressure, wall-heat and finite-volume
balance measures.}
...
\input{generated_steady_seed_robustness_text}}{}
}{}
